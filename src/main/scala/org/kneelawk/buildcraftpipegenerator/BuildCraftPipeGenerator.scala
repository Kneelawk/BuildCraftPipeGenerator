...
object BuildCraftPipeGenerator {
  def main(args: Array[String]) {
    ...
    for (i <- 0 until 0x40) {
      ...
      val vt01 = ctx.addTexCoord(Vec2d(04d / 16d, 16d / 16d))
      val vt02 = ctx.addTexCoord(Vec2d(12d / 16d, 16d / 16d))
      val vt03 = ctx.addTexCoord(Vec2d(00d / 16d, 12d / 16d))
      val vt04 = ctx.addTexCoord(Vec2d(04d / 16d, 12d / 16d))
      val vt05 = ctx.addTexCoord(Vec2d(12d / 16d, 12d / 16d))
      val vt06 = ctx.addTexCoord(Vec2d(16d / 16d, 12d / 16d))
      val vt07 = ctx.addTexCoord(Vec2d(00d / 16d, 04d / 16d))
      val vt08 = ctx.addTexCoord(Vec2d(04d / 16d, 04d / 16d))
      val vt09 = ctx.addTexCoord(Vec2d(12d / 16d, 04d / 16d))
      val vt10 = ctx.addTexCoord(Vec2d(16d / 16d, 04d / 16d))
      val vt11 = ctx.addTexCoord(Vec2d(04d / 16d, 00d / 16d))
      val vt12 = ctx.addTexCoord(Vec2d(12d / 16d, 00d / 16d))
